...
namespace HospitalitySpa
{
    public class CompVendingMachine : ThingComp, IThingHolder
    {
        ...
        public bool ShouldBeEmptied()
        {
            ...
            if (GenDate.TicksGame > lastEmptyTick + GenDate.TicksPerHour * HospitalitySpaMod.Settings.EmptyAfterHours) return true;
            return false;
        }
        ...
        public override IEnumerable<Gizmo> CompGetGizmosExtra()
        {
            if(!Properties.noToggle)
                ...
                {
                    defaultLabel = "HospitalitySpa_VendingMachine".Translate(),
                    defaultDesc = "HospitalitySpa_VendingMachineToggleDesc".Translate(),
            ...
            if (IsActive())
            {
                ...
                {
                    defaultLabel = "HospitalitySpa_SetPricing".Translate(),
